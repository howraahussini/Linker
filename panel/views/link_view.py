...
from panel.models import Link
from panel.forms import LinkForm



class LinkView(CommonContextMixin, LoginRequiredMixin, UserPassesTestMixin, FormView):
    '''
    this is for displaying Link form in the template.
    '''

    template_name = 'panel/link/link.html'
    model = Link
    form_class = LinkForm
...
class LinkEditView(CommonContextMixin, LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    '''
    this is for displaying the Link edit form in the template.
    '''

    template_name = 'panel/link/link_edit.html'
    model = Link
    form_class = LinkForm
