...
from panel.models import Gallery
from panel.forms import GalleryForm



class GalleryView(CommonContextMixin, LoginRequiredMixin, UserPassesTestMixin, FormView):
    '''
    this is for displaying Gallery form in the template.
    '''

    template_name = 'panel/gallery/gallery.html'
    model = Gallery
...
class GalleryEditView(CommonContextMixin, LoginRequiredMixin,  UserPassesTestMixin, UpdateView):
    '''
    this is for displaying the Gallery edit form in the template.
    '''

    template_name = 'panel/gallery/gallery_edit.html'
    model = Gallery
    form_class = GalleryForm
