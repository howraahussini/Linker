...
class InstagramView(CommonContextMixin, LoginRequiredMixin, UserPassesTestMixin, FormView):
    '''
    this is for displaying Instagram form in the template.
    '''

    template_name = 'social_media/Instagram/Instagram.html'
    model = Instagram
...
class InstagramEditView(CommonContextMixin, LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    '''
    this is for displaying the Instagram edit form in the template.
    '''

    template_name = 'social_media/Instagram/Instagram_edit.html'
    model = Instagram
    form_class = InstagramForm
...
class InstagramDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    '''
    this is for deleting Instagram.
    '''
