...
from ..models import Snapchat
from ..forms import SnapchatForm



class SnapchatView(CommonContextMixin, LoginRequiredMixin, UserPassesTestMixin, FormView):
    '''
    this is for displaying Snapchat form in the template.
    '''

    template_name = 'social_media/Snapchat/Snapchat.html'
    model = Snapchat
    form_class = SnapchatForm
...
class SnapchatEditView(CommonContextMixin, LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    '''
    this is for displaying the Snapchat edit form in the template.
    '''

    template_name = 'social_media/Snapchat/Snapchat_edit.html'
    model = Snapchat
    form_class = SnapchatForm
...
class SnapchatDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    '''
    this is for deleting Snapchat.
    '''
