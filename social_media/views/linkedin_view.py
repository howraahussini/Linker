...
class LinkedinView(CommonContextMixin, LoginRequiredMixin, UserPassesTestMixin, FormView):
    '''
    this is for displaying Linkedin form in the template.
    '''

    template_name = 'social_media/Linkedin/Linkedin.html'
    model = Linkedin
    form_class = LinkedinForm
...
class LinkedinEditView(CommonContextMixin, LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    '''
    this is for displaying the Linkedin edit form in the template.
    '''

    template_name = 'social_media/Linkedin/Linkedin_edit.html'
    model = Linkedin
    form_class = LinkedinForm
...
class LinkedinDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    '''
    this is for deleting Linkedin.
    '''
