...
class XView(CommonContextMixin, LoginRequiredMixin, UserPassesTestMixin, FormView):
    '''
    this is for displaying X form in the template.
    '''

    template_name = 'social_media/X/X.html'
    model = X
    form_class = XForm
...
class XEditView(CommonContextMixin, LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    '''
    this is for displaying the X edit form in the template.
    '''

    template_name = 'social_media/X/X_edit.html'
    model = X
    form_class = XForm
