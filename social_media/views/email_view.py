...
class EmailView(CommonContextMixin, LoginRequiredMixin, UserPassesTestMixin, FormView):
    '''
    this is for displaying Email form in the template.
    '''

    template_name = 'social_media/Email/Email.html'
    model = Email
...
class EmailEditView(CommonContextMixin, LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    '''
    this is for displaying the Email edit form in the template.
    '''

    template_name = 'social_media/Email/Email_edit.html'
    model = Email
    form_class = EmailForm
